...
// --- Icon Components (can be moved to a central icons.js file later) ---
...
const LoginScreen = ({ navigation }) => {
  ...
  const { login, forgotPassword } = useAuth(); // 1. Get forgotPassword from context
          ...
          <ScrollView contentContainerStyle={styles.scrollViewContent} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.formContainer}>
                ...
                <TextInput
                    ...
                    secureTextEntry
                />
                {/* 3. Attach the handler to the TouchableOpacity */}
...
const styles = StyleSheet.create({
  ...
  button: { borderRadius: 12, height: 56, alignItems: 'center', justifyContent: 'center', backgroundColor: theme.colors.primary },
